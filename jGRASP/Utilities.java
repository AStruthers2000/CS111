...
public class Utilities {
    ...
    public static void printHelp() {
        ...
        System.out.println("  worship    - will increase your spirit approval percentage\n\tNote: only works in the Prayer Room");
        System.out.println("  view map   - shows a map of the entire house\n\tNote: only works in the Map Room");
