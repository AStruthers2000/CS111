public class GameV3 {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("\tIn this version, there are more than six rooms, with 5 MonsterRooms, with special behavior, instead of a regular Room.\nThere is also a new CustomPlayer instead of the default Player, with two different fields and behaviors.");
        System.out.println("==========\n");
